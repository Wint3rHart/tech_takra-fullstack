...
<motion.p variants={childVar} className={`text-6xl [text-shadow:2px_4px_5px_rgba(0,0,0,0.6)]  ${cormotant.className} font-raleway`}>{React.Children.toArray(x)[0].props.children}</motion.p>

<motion.div style={{y:yC}} variants={childVar} className={`${tangerine.className} text-8xl font-bold font-tangerine  text-[#d4af37]  [text-shadow:2px_4px_5px_rgba(0,0,0,0.6),0_0_10px_rgba(255,255,255,0.4)] font-black flex `}>
   <motion.p  variants={grandChildVar} >{x?.[1]?.props?.children}</motion.p></motion.div>

<motion.p variants={childVar} className={`text-6xl font-playfair  ${cormotant.className}  [text-shadow:2px_4px_5px_rgba(0,0,0,0.6)] font-semibold`}>{x?.[2]?.props?.children}</motion.p>
</motion.div> 

<motion.div variants={parentVar}  className={`flex items-center ${tangerine.className} text-6xl font-bold font-tangerine   text-[#d4af37] justify-center w-[100vw]`}>
 ...
 <motion.p variants={childVar} className={`mt-6 flex font-bold font-playfair  ${cormotant.className}     text-[#d4af37] text-xl items-center justify-center`}>
