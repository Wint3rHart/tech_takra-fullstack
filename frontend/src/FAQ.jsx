  ...
  return (
    <section className="py-10 z-90">
      <div className="container mx-auto px-[15px] lg:px-[35px] max-w-4xl">
        <h6 className="cursor-pointer w-full text-[#C5B358] font-orbitron sm:text-[20px] leading-[38px] sm:leading-[32px] md:leading-[40px] lg:leading-[48px]">
          Frequently Asked Questions – Wandering Hart
        </h6>

        <div className="overflow-y-auto max-h-[500px] space-y-4 pr-2 scrollbar-thin scrollbar-thumb-gray-300 hover:scrollbar-thumb-gray-400 scrollbar-track-transparent">
